...
class ChatHandler:
    ...
    def handle(self, msg: str) -> str:
        ...
        # ✅ Handle general KB questions at ANY point (mid-flow included)
        if self._is_general_question(m):
            kb_answer = ask_general(msg)
            # Embed KB answer with current step prompt if needed
        ...
        if self.step == 3:
            ...
            # If reason is already given without asking
        ...
        if self.step == 4:
            # If they give a reason here, acknowledge before benefits
        ...
        if self.step == 6:
            ...
            # If they give another reason here
